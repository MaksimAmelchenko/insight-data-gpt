...
```bash
cd apps/api
NODE_ENV=development-local npx knex migrate:make 'migration_name'
```
...
```bash
cd apps/api
NODE_ENV=development-local npx knex migrate:up
```
...
```bash
cd apps/api
NODE_ENV=development-local npx knex migrate:down
```
