...
import { ArrowLeftIcon, DotsVerticalIcon, PlusIcon, Trash01Icon } from '@org/ui-kit';
...
export function MoreButton({ onClick, className }: ButtonProps): JSX.Element {
  return (
    <button type="button" className={clsx(styles.button, styles.button_endAdornment, className)} onClick={onClick}>
      <DotsVerticalIcon />
    </button>
  );
}
