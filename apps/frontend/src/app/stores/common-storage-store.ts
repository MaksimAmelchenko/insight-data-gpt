 ...
 */
export class CommonStorageStore<StoredData extends Record<string, any>> extends ManageableStore {
   ...
   * Does not throw, except when used out of Auth context (user didn't log in)
   * @param {string} key
   * @param {T} value
   * @return {T | undefined}
   */
