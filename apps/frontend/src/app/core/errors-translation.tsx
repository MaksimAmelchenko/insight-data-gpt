...
/**
 * For each CoreError subclass, you may pass a human-readable (HR) string
...
export const defaultApiErrorsHR: [CoreErrorConstructor, ErrorTranslation][] = [
  [ApiErrors.Unauthorized, 'The requested resource is restricted and requires authentication.'],
  [ApiErrors.NetworkError, 'Could not connect to servers, please try again'],
  [ApiErrors.ServerError, 'Something wrong happened with server, please try again.'],
  [CoreError, 'Something went wrong, please try again'],
];
